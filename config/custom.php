...
return [
    'custom' => [
        ...
        'templateTitle' => 'PENDLHDKI', //template Title can be changes default('Materialize)
        'defaultLanguage' => 'en', //set your default language Options: en(default),pt,fr,de
        'largeScreenLogo' => 'images/logo/materialize-logo-color.png', //used saparete log image for large screen and small
        'smallScreenLogo' => 'images/logo/materialize-logo.png', // pass the image path here note:(Vertical-menu-nav-dark and horizontal-menu template used a single logo in both small and large screen)
