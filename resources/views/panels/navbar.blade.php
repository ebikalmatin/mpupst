  ...
  <nav
    ...
    <div class="nav-wrapper">
      <div class="header-search-wrapper hide-on-med-and-down">
        ...
        <input class="header-search-input z-depth-2" type="text" name="Search" placeholder="Cari Data"
      ...
      <ul class="dropdown-content" id="notifications-dropdown">
        <li>
          <h6>NOTIFIKASI<span class="new badge">2</span></h6>
        </li>
        <li class="divider"></li>
        <li>
          <a class="black-text" href="javascript:void(0)">
            <span class="material-icons icon-bg-circle cyan small">add</span>
            Task baru telah ditambahkan!
          </a>
      ...
      <div class="nav-wrapper">
        <form id="navbarForm">
          <div class="input-field search-input-sm">
            <input class="search-box-sm mb-0" type="search" required="" placeholder='Cari Data' id="search"
              data-search="starter-kit-list">
